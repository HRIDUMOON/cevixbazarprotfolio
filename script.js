...
function openModal(index) {
    ...
    if (linkUrl) {
        // Jodi link er surute http ba https na thake, tahole auto add kore nibe
        if (!linkUrl.startsWith('http://') && !linkUrl.startsWith('https://')) {
            linkUrl = 'https://' + linkUrl;
        }
        demoBtn.href = linkUrl;
        demoBtn.style.display = 'inline-flex'; // Link thakle button dekhabe
    } else {
        demoBtn.href = '#';
        demoBtn.style.display = 'none'; // Link na thakle button lukabe
    }
    // ---------------------------
